...
module.exports = class Db {
     ...
     * @param {Object} opts - options to pass to the layer.
     *
    ...
    createDatabase(name, opts) {
      ...
      return this.methods.createDatabase(name, opts);
    }
    ...
    query(query, vars) {
      ...
      console.warn('WARNING:', 'Using a query makes it most likely DB specific, this is not recommended.')
